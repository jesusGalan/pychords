...
with description('Generating scales'):
        ...
        with context("escala mixta o hindu"):
            ...
            with it('escala_locria_natural_2_6'):
                ...
                expect(scales(scale, note)).to(equal(['C#', 'D#', 'E', 'F#', 'G', 'A#', 'B']))

            with it('escala_frigia_mayor_#9'):
                note = "D#"
                scale = "escala_frigia_mayor_#9"

                expect(scales(scale, note)).to(equal(['D#', 'E', 'F#', 'G', 'A#', 'B', 'C#']))
            ...
            with it('escala_mixolidia_b2'):
                ...
                expect(scales(scale, note)).to(equal(['F#', 'G', 'A#', 'B', 'C#', 'D#', 'E']))

            with it('escala_lidia_#2_#5'):
                note = "G"
                scale = "escala_lidia_#2_#5"

                expect(scales(scale, note)).to(equal(['G', 'A#', 'B', 'C#', 'D#', 'E', 'F#']))
